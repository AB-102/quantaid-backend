...
def list_lessons():
    ...
    lessons = list(db.lessons_v2.find(
        {},
...
def update_lesson(course_id: int):
    ...
    result = db.lessons_v2.update_one(
        {'courseId': course_id},
        {'$set': update_fields}
    )
...
def reorder_lessons():
    ...
    for new_idx, old_course_id in enumerate(order):
        db.lessons_v2.update_one(
            ...
            {'$set': {'courseId': temp_offset + new_idx, 'updated_at': now}}
        )

    # Phase 2: move from temp to final
    for new_idx in range(len(order)):
        db.lessons_v2.update_one(
            {'courseId': temp_offset + new_idx},
            {'$set': {'courseId': new_idx}}
        )
...
DEFAULT_DASHBOARD_CONFIG = {
    ...
    'courses': [
        {
            'id': 0, 'title': 'Introduction to Quantum Computing',
            'description': 'Discover what quantum computing is and how it differs from classical computing.',
            'image': 'lesson-0',
            'concepts': [
                {
                    'id': 'basics', 'title': 'Quantum Computing Fundamentals',
                    'topics': [
                        {'id': 0, 'title': 'Welcome to Quantum Computing', 'description': 'Discover what quantum computing is and how it differs from classical computing.', 'implemented': True},
        ...
        {
            'id': 1, 'title': 'Basic Quantum Principles',
            'description': 'Understand wave-particle duality, superposition, entanglement, and more.',
            'image': 'lesson-1',
            'concepts': [
                {
                    'id': 'core-concepts', 'title': 'Qubits, Superposition, and Entanglement',
                    'topics': [
                        {'id': 1, 'title': 'Basic Quantum Principles', 'description': 'Understand wave-particle duality, superposition, entanglement, and more.', 'implemented': True},
                ...
                {
                    'id': 'measurements', 'title': 'Quantum Measurements',
                    'topics': [
        ...
        {
            'id': 2, 'title': 'Quantum Gates and Circuits (Basics)',
            'description': 'Explore how quantum gates form the building blocks of quantum circuits.',
            'image': 'lesson-2',
            'concepts': [
                {
                    'id': 'single-gates', 'title': 'Single Qubit Gates',
                    'topics': [
                        {'id': 2, 'title': 'Quantum Gates and Circuits (Basics)', 'description': 'Explore how quantum gates form the building blocks of quantum circuits.', 'implemented': True},
                ...
                {
                    'id': 'multi-gates', 'title': 'Multi-Qubit Gates',
                    'topics': [
                ...
                {
                    'id': 'circuits', 'title': 'Building Circuits',
                    'topics': [
        ...
        {
            'id': 3, 'title': 'Getting Hands-On',
            'description': 'Learn practical quantum computing with real-world examples.',
            'image': 'lesson-0',
            'concepts': [
                {
                    'id': 'practical', 'title': 'Practical Implementation',
                    'topics': [
                        {'id': 3, 'title': 'Getting Hands-on', 'description': 'Learn practical quantum computing with real-world examples.', 'implemented': True},
        ...
        {
            'id': 4, 'title': 'Foundations for Quantum Computing',
            ...
            'concepts': [
                {
                    ...
                    'topics': [
                        {'id': 4, 'title': 'Foundations for Quantum Computing', 'description': 'Dive deeper into the essential math and physics behind quantum computing.', 'implemented': True},
        ...
        {
            'id': 5, 'title': 'Quantum Cryptography & Security',
            'description': 'Learn how quantum computing impacts cryptography, encryption and security protocols.',
            'image': 'lesson-2',
            'concepts': [
                {
                    'id': 'cryptography', 'title': 'Quantum Security',
                    'topics': [
                        {'id': 5, 'title': 'Quantum Cryptography & Security', 'description': 'Learn how quantum computing impacts cryptography, encryption and security protocols.', 'implemented': True},
        ...
        {
            'id': 6, 'title': 'Adiabatic Quantum Computing',
            'description': 'Explore the adiabatic model and quantum annealing techniques.',
            'image': 'lesson-0',
            'concepts': [
                {
                    'id': 'adiabatic', 'title': 'Adiabatic Computing',
                    'topics': [
                        {'id': 6, 'title': 'Adiabatic Quantum Computing', 'description': 'Explore the adiabatic model and quantum annealing techniques.', 'implemented': True},
        ...
        {
            'id': 7, 'title': 'Quantum Signal Processing & Simulation',
            'description': 'Understand how quantum systems simulate complex physical processes.',
            'image': 'lesson-1',
            'concepts': [
                {
                    'id': 'signal-processing', 'title': 'Signal Processing & Simulation',
                    'topics': [
                        {'id': 7, 'title': 'Quantum Signal Processing & Simulation', 'description': 'Understand how quantum systems simulate complex physical processes.', 'implemented': True},
        ...
        {
            'id': 8, 'title': 'Quantum Hardware & Future Trends',
            'description': 'Discover the cutting-edge hardware behind quantum computers.',
            'image': 'lesson-2',
            'concepts': [
                {
                    'id': 'hardware', 'title': 'Hardware & Future',
                    'topics': [
                        {'id': 8, 'title': 'Quantum Hardware & Future Trends', 'description': 'Discover the cutting-edge hardware behind quantum computers.', 'implemented': True},
